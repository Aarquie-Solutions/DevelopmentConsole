...
#endif
			{
				...
				try
				{
					foreach( Type type in assembly.GetExportedTypes() )
					{
						...
						{
							foreach( object attribute in method.GetCustomAttributes( typeof( DevConsoleMethodAttribute ), false ) )
							{
								DevConsoleMethodAttribute consoleMethod = attribute as DevConsoleMethodAttribute;
